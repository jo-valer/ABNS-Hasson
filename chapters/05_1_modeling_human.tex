...
The stricter case of cross-validation titled ``CV control" explains the similarity judgments better than raw  representations. In this case no single images occurred in both training folds and test folds of cross-validation. However, for ``Transformed model", the exclusivity was in respect to pair of images.
