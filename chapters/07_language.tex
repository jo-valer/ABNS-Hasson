...
\osst{Note: some researchers think people do not make predictions on the next word. They think: once the word is received, the fit of the new word given the previous context is computed. If the fit is low, then the surprise is high. There is a heated debate about whether people make predictions or not.}
...
\subsection{Abstract rules (Chomsky grammar)}
