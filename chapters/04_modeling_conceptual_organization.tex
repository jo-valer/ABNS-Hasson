...
\begin{figure}
    ...
    \includegraphics[width=0.65\linewidth]{images/mitchell.png}
...
Predicting word activity in each voxel just means multiplying its semantic feature values by learned weights.
