...
\newcommand\notets{\textbf{\textcolor{\stdcolor}{\textsuperscript{$_{\sqbox1{}}$}}}}
...
\newcommand\boxl[2]{
\begin{tcolorbox}[colback=\stdcolorlight!white,colframe=\stdcolor!black,title=#1]
#2
\end{tcolorbox}
}
...
In the GitHub repository\footnote{TODO} you can find the LaTex source code, where you can create issues and pull requests to include topics and corrections.\\
...
\subfile{chapters/02_overview}
\subfile{chapters/03_categories}
\subfile{chapters/04_modeling_conceptual_organization}
% \subfile{chapters/05_modeling_human}
% \subfile{chapters/06_human_memory}
% \subfile{chapters/07_language}
% \subfile{chapters/08_attention}
